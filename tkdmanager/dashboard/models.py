...
class Award(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('dashboard:award-detail', args=[str(self.id)])
...
class Member(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse('dashboard:member-detail', args=[str(self.id)])
...
class Grading(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse('dashboard:grading-detail', args=[str(self.id)]) 
...
class GradingResult(models.Model):
    ...
    def get_absolute_url(self):
        """Returns the URL to access a detail record for this member's grading results."""
        return reverse('dashboard:grading-result-detail', args=[str(self.id)]) 
...
class GradingInvite(models.Model):
    ...
    def get_absolute_url(self):
        """Returns the URL to access a detail record for this member's grading results."""
        return reverse('dashboard:grading-invite-detail', args=[str(self.id)]) 
...
class Class(models.Model):
    ...
    def get_absolute_url(self):
        """Returns the URL to access a detail record for this member's grading results."""
        return reverse('dashboard:class-detail', args=[str(self.id)]) 
...
class Payment(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('dashboard:payment-detail', args=[str(self.id)])
