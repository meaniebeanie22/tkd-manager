...
class Award(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('award-detail', args=[str(self.id)], current_app='dashboard')
...
class Member(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse('member-detail', args=[str(self.id)], current_app='dashboard')
...
class Grading(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse('grading-detail', args=[str(self.id)], current_app='dashboard') 
...
class GradingResult(models.Model):
    ...
    def get_absolute_url(self):
        """Returns the URL to access a detail record for this member's grading results."""
        return reverse('grading-result-detail', args=[str(self.id)], current_app='dashboard') 
...
class Class(models.Model):
    ...
    def get_absolute_url(self):
        """Returns the URL to access a detail record for this member's grading results."""
        return reverse('class-detail', args=[str(self.id)], current_app='dashboard') 
...
class Payment(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('payment-detail', args=[str(self.id)], current_app='dashboard')
