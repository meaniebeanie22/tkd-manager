...
urlpatterns = [
    ...
    path('assessment-unit/create', views.AssessmentUnitCreate.as_view(), name='add-assessment-unit'),
    path('assessment-unit/<int:pk>/update', views.AssessmentUnitUpdate.as_view(), name='update-assessment-unit')
]