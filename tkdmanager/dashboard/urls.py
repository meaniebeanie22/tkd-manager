...
urlpatterns = [
    ...
    path('payment-tyoe/<str:pk>/update', views.PaymentTypeUpdate.as_view(), name='dash-update-payment-type'),
    ...
    path('recurringpayment/create', views.RecurringPaymentCreateView.as_view(), name='dash-add-rpayment'),
